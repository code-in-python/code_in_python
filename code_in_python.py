...
class Game:
    def __init__(self, background_active, rooms_in_game):
        ...
        # settings for music played in the game
    ...
    def draw_finish(self):
        ...
        if self.music_play:
            # change to False, this will only be done once
        ...
        if len(room.doors):
            for door in room.doors:
                if (
                    ...
                    self.shift_ok = False
                    # we play the sound of an opening door
                    sounds.door.play()
                    ...
                    # if we enter the auditorium the game ends
    ...
    def get_key(self):
        def check_all_keys(keys):
            for any_key in keys:
                ...
                # allow entry through the secret door stored at index 1
                # of the door list held in the room_08 instance of the Room class
    ...
    def draw_scene(self):
        ...
        if self.game_start:
            ...
            self.draw_key()
            # we draw a hidden door that Max can go through
